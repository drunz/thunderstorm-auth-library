...
from thunderstorm_auth.permissions import (
    validate_permission, get_registered_permissions, register_permission,
    get_permissions_info, Permission
)
...
def test_get_permissions_info(mock_get_registered_permissions):
    ...
    db_permissions = [
        make_permission(
            uuid='e42b63b0-1014-11e8-bd6c-4a0004692f50',
            permission='perm1',
            is_deleted=False
        ),
        make_permission(
            uuid='03a019de-1015-11e8-a5a0-4a0004692f50',
            permission='perm2',
            is_deleted=False
        ),
        make_permission(
            uuid='3a2f335e-1015-11e8-9a86-4a0004692f50',
            permission='perm3',
            is_deleted=True
        )
    ]
