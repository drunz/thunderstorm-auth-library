        ...
        stage('Test') {
            withEnv([
              ...
              parallel 'python35': {
                ...
                sh "docker-compose run -e CODACY_PROJECT_TOKEN=${env.CODACY_PROJECT_TS_AUTH_LIB_TOKEN} -e PYTHON_VERSION=36 -e COMPAT=compat -e DB_NAME=test_auth_lib_py36compat python36 make install compat test codacy"
